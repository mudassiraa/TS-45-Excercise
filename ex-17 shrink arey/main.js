...
while (guestList.length > 2) {
    ...
    console.log("Sorry, ".concat(guestRemoved, " I can't invite you for dinner."));
}
console.log("invitations for the last 2 guest.");
guestList.forEach(function (luckytwo) { return console.log("Dear ".concat(luckytwo, ", you are still invited for dinner.")); });
guestList.pop();
guestList.pop();
